...
from app.models.posts import PostCategories, PostMedia, PostType, Posts, PostHashTags
...
def create_post(post_data: dict) -> Tuple[Response, int]:
    ...
    if post_data["post_type"] not in PostType.__members__:
    ...
    if "hashtags" in post_data:
        ...
        try:
            ...
            return jsonify({"message": "An error occurred while adding hashtags", "error": str(e)}), 500
